      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ padding: '1.5rem' }}>
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input type="number" defaultValue={80} style={{ width: '100%', padding: '0.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)' }} />
          ...
          <div>
            ...
            <select style={{ width: '100%', padding: '0.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)' }}>
      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        ...
        <div style={{ padding: '1.5rem' }}>
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <input type="password" defaultValue="sk_live_mock_token_12345" style={{ width: '100%', padding: '0.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)' }} />
          </div>
        </div>
      </div>

      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <button className="btn-solid" style={{ minWidth: 'auto', padding: '0.75rem 1.5rem' }}>
