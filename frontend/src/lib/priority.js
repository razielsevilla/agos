...
export const PRIORITY_LEVELS = [
  {
    ...
    badgeClass: 'danger',
    icon: Siren,
    tooltip: 'Peak Flood Risk 75%+. Life-threatening conditions right now — immediate evacuation response needed.',
    mapColor: '#ef4444',
    mapFillColor: '#ef4444',
    mapRadius: 450,
  ...
  },
  {
    ...
    badgeClass: 'warning',
    icon: AlertTriangle,
    tooltip: 'Peak Flood Risk 50-74%. Conditions are close to critical — prepare to respond.',
    mapColor: '#f97316',
    mapFillColor: '#f97316',
    mapRadius: 350,
  ...
  },
  {
    ...
    badgeClass: 'moderate',
    icon: Triangle,
    tooltip: 'Peak Flood Risk 25-49%. Not critical yet, but worth close monitoring.',
    mapColor: '#0ea5e9',
    mapFillColor: '#0ea5e9',
    mapRadius: 250,
  ...
  },
  {
    ...
    badgeClass: 'normal',
    icon: ClipboardList,
    tooltip: 'Peak Flood Risk below 25%. No significant flood hazard detected right now.',
    mapColor: '#64748b',
    mapFillColor: '#64748b',
    mapRadius: 180,
    tintBg: 'var(--bg-app)',
